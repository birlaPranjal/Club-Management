          ...
          <div className={styles.tag}>
            ...
            <div className={styles.addtag}>
              <LabelCard
                ...
                onClick={() =>
                  handleLabelClick(
                    label === "Add Labels" ? "UI Design" : "Add Labels"
                  )
                }
              />
              <div className={styles["dropdown-menu"]}>
                <LabelCard
                  label={"UI Design"}
                  onClick={() => handleLabelClick("UI Design")}
                />
                <LabelCard
                  label={"Content"}
                  onClick={() => handleLabelClick("Content")}
                />
                <LabelCard
                  label={"Web dev"}
                  onClick={() => handleLabelClick("Web dev")}
                />
                <LabelCard
                  label={"Others"}
                  onClick={() => handleLabelClick("Others")}
                />
              </div>
            </div>
          </div>
